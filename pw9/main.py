...
def main():
    ...
    button_exit = tk.Button(window, text="Exit", command = do_exit, width=30, height=2)
    button_exit.pack()
    button_input_students = tk.Button(window, text="Input number of students", command = do_input_students, width=30, height=2)
    button_input_students.pack()
    button_input_courses = tk.Button(window, text="Input number of courses", command = do_input_courses, width=30, height=2)
    button_input_courses.pack()
    button_input_students_info = tk.Button(window, text="Input students' information", command = do_input_students_info, width=30, height=2)
    button_input_students_info.pack()
    button_input_courses_info = tk.Button(window, text="Input courses' information", command = do_input_courses_info, width=30, height=2)
    button_input_courses_info.pack()
    button_input_marks = tk.Button(window, text="Input marks", command = do_input_marks, width=30, height=2)
    button_input_marks.pack()
    button_display_students = tk.Button(window, text="Display students' information", command = do_display_students, width=30, height=2)
    button_display_students.pack()
    button_display_courses = tk.Button(window, text="Display courses' information", command = do_display_courses, width=30, height=2)
    button_display_courses.pack()
    button_gpa = tk.Button(window, text="Sort Students by GPA", command=do_gpa, width=30, height=2)
    button_gpa.pack()
    window.mainloop()
